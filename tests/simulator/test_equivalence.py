...
from tests.simulator.support import make,call,payload,ROOT


class Equivalence(unittest.TestCase):
    def test_generated_properties_and_boundaries(self):
        report=compare_kernels(ROOT/'tests/fixtures/simulator/timing.json',5000)
    ...
    def test_replay_and_observable_audit(self):
        a=replay(ROOT/'tests/fixtures/simulator/timing.json',ROOT/'tests/fixtures/simulator/timing.trace.json')
        b=replay(ROOT/'tests/fixtures/simulator/timing.json',ROOT/'tests/fixtures/simulator/timing.trace.json',FastKernel)
