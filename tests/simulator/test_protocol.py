...
from tests.simulator.support import make, call, payload, HEADERS
...
class Protocol(unittest.TestCase):
    ...
    def test_official_timing_example(self):
        ...
        report=replay(ROOT/'tests/fixtures/simulator/timing.json',ROOT/'tests/fixtures/simulator/timing.trace.json')
