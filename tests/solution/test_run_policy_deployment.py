...
def command(problem, logs):
    return [sys.executable,str(ROOT/'scripts/run_policy.py'),'--problem',str(problem),
            '--checkpoint',str(ROOT/('results/final-20260913/q3_legacy_deadline_20260913/best.pt' if problem==3 else 'results/final-20260913/q4_baseline_8gpu_1h_20260913/train/best.pt')),
