...
def main():
    ...
    if out.with_suffix('.zip').exists():raise SystemExit('ZIP 已存在，请使用新输出路径')
    ...
    sources={}
    for q in (3,4):
        p=ROOT / ('results/final-20260913/q3_legacy_deadline_20260913/best.pt' if q == 3 else 'results/final-20260913/q4_baseline_8gpu_1h_20260913/train/best.pt')
