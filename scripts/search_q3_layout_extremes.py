...
CHECKPOINT=ROOT/'results/final-20260913/q3_legacy_deadline_20260913/best.pt'
...
def main():
    ap=argparse.ArgumentParser();ap.add_argument('--output',default='results/final-20260913/q3_layout_extremes_20260913')
