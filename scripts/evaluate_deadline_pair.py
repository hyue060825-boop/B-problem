...
def main():
    ...
    checkpoints = {
        ...
        'q4_best': str(ROOT / 'results/final-20260913/q4_legacy_deadline_20260913/best.pt'),
        'q4_baseline': str(ROOT / 'results/final-20260913/q4_budget_20260912/train/best.pt'),
    }
    torch.set_num_threads(1)
    frozen = {}
    for name, path in checkpoints.items():
