...
def main():
    ...
    checkpoints = {
        'q3_candidate': 'runs/q3_joint_20260912/ppo_candidate.pt',
        'q3_baseline': 'runs/q3_joint_20260912/baseline.pt',
        'q4_best': 'runs/q4_budget_20260912/train/best.pt',
        'q4_baseline': 'runs/q4_repaired_20260912/train/best.pt',
    }
    torch.set_num_threads(1)
    frozen = {}
    for name, path in checkpoints.items():
