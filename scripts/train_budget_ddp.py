...
def main():
    ...
    def save(path):
        ...
        if rank==0:
            ...
            save_checkpoint(path,model,opt,cfg,'BUDGET_DDP_PPO',iteration-1,{},dict(budget_consumed_s=consumed+time.perf_counter()-started,best_delta=best,rank_rng=rank_rng,
