...
def main():
    p=argparse.ArgumentParser();p.add_argument('--output',default='results/training/q3_joint_new');a=p.parse_args()
    out=Path(a.output);out.mkdir(parents=True,exist_ok=True)
    source=Path('results/training/import-4d75bee/large_20260911/q3_ext_gpu2/best.pt')
    ...
    atomic_json(out/'config.json',cfg);Path('experiments/q3').mkdir(parents=True,exist_ok=True);atomic_json('experiments/q3/joint-generated.json',cfg)
