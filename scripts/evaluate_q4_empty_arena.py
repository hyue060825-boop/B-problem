...
def main():
    ...
    ap.add_argument('--checkpoint',default=str(ROOT/'results/final-20260913/q4_legacy_deadline_20260913/best.pt'))
    ap.add_argument('--output',default=str(ROOT/'results/final-20260913/q4_empty_arena_20260913'))
    args=ap.parse_args()
...
使用原最佳基线 `results/final-20260913/q4_legacy_deadline_20260913/best.pt`，未使用正在续训的中间权重。原冻结控制器、原证书和 greedy 模型选择均保留。
