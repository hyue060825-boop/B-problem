...
def main():
    ...
    p.add_argument('--q3-seed', type=int, required=True)
    p.add_argument('--q4-seed', type=int, required=True)
    a = p.parse_args()
    ...
    checkpoints = {
        'q3_candidate': str(ROOT / 'results/final-20260913/q3_legacy_deadline_20260913/best.pt'),
        'q3_baseline': str(ROOT / 'results/final-20260913/q3_gpu8_extended_20260912/ppo/best.pt'),
        'q4_best': str(ROOT / 'results/final-20260913/q4_baseline_8gpu_1h_20260913/train/best.pt'),
        'q4_baseline': str(ROOT / 'results/final-20260913/q4_legacy_deadline_20260913/best.pt'),
    }
    torch.set_num_threads(1)
    frozen = {}
    for name, path in checkpoints.items():
