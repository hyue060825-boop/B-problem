...
def main():
    ...
    parser.add_argument('--input', default='runs/q4_absence_tail_analysis_20260913_v2')
    ...
    ctl = Controller(4)
    ready, request = {}, None
    for line in Path('/data5/hy/logQ4.jsonl').read_text(encoding='utf-8-sig').splitlines():
        row = json.loads(line)
