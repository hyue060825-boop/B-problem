...
spec_version: "1.0"
figure_id: "F008"
working_title: "Q3/Q4：训练期间的验证变化"
status: "RENDERED"
outputs:
  source: "../../../scripts/build_handoff_assets.py"
  vector: "../F008-q34-validation-progress.pdf"
  preview: "../F008-q34-validation-progress.png"
---
...
Q3 联合 PPO 阶段是理解本图的入口，结论以绑定来源为限。
...
Q3 为第 16/32/48/64 轮；Q4 每 100 轮验证至 3800，best 为第 3500 轮。
## 3.3 Source Binding
- [results/training/import-3ddb2d9/runs/q3_joint_20260912/ppo](../../../results/training/import-3ddb2d9/runs/q3_joint_20260912/ppo)
- [results/training/import-3ddb2d9/runs/q4_budget_20260912/train](../../../results/training/import-3ddb2d9/runs/q4_budget_20260912/train)
- [handoff/tables/training_validation.csv](../../../handoff/tables/training_validation.csv)
## 3.4 Optional / Removable Content
可移除图内标题；保留轴、图例、单位和关键几何对象。
## 3.5 Assumptions / Open Questions
不把反复使用的验证集称为独立测试；不插值成未记录的训练性能。
