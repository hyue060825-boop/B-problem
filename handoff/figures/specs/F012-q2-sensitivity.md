...
spec_version: "1.0"
figure_id: "F012"
working_title: "Q2权重与候选离散化敏感性"
status: "RENDERED"
outputs:
  source: "../../../scripts/build_q2_literature_assets.py"
  vector: "../F012-q2-sensitivity.pdf"
  preview: "../F012-q2-sensitivity.png"
---
...
不将12场景称为最终评估集；5档等距敏感性网格不同于主实验5档非等距网格；不回选最优权重。
