...
spec_version: "1.0"
figure_id: "F004"
working_title: "Q3：七站覆盖结构"
status: "RENDERED"
outputs:
  source: "../../../scripts/build_handoff_assets.py"
  vector: "../F004-q3-coverage.pdf"
  preview: "../F004-q3-coverage.png"
---
...
目标圆半径 1800 m是理解本图的入口，结论以绑定来源为限。
...
目标圆 1800 m；外圈 1135 m；接收保护半径 999.98 m；覆盖上界约 994.81 m。
## 3.3 Source Binding
- [src/solution/coverage/certificates.py](../../../src/solution/coverage/certificates.py)
- [handoff/tables/q3_coverage_parameters.csv](../../../handoff/tables/q3_coverage_parameters.csv)
