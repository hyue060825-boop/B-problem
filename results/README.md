...
- `figures/`、`tables/`：后续实验生成的图表。当前写作图表统一从 [handoff/figures](../handoff/figures/README.md) 和 [handoff/tables](../handoff/tables/README.md) 取用，原图保留在所属批次。

接收和版本记录集中在 [records/](../records/README.md)；数据、权重和图件清点见[资产索引](../records/inventory/README.md)。

已有记录：[早期模拟器导入](validation/import-b192804/README.md)、[早期整合验证](validation/integration-20260911-4f12388/README.md)、[hy 报告和算例](validation/import-c457828/README.md)、[前批研究训练](training/import-c457828/README.md)、[大规模训练交付](training/import-4d75bee/README.md)、[Q3 四路选模验证](validation/q3-large-4d75bee/summary.json)、[Q3 3000 局评估](validation/q3-3000-9e10994/README.md)、[最新训练与评估](training/import-3ddb2d9/README.md)、[本次接收验证](validation/integration-3ddb2d9/README.md)。当前已有自建分布研究结果，质量与复现问题见[接收记录](../records/acceptance/接收记录-3ddb2d9.md)；尚未交付官方演练或正式成绩。
