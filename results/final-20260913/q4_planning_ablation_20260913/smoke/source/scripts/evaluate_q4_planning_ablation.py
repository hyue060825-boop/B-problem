...
from experiments.q4_planning import VARIANTS, TWO_OPT_PASSES, select_action
...
def main():
    ...
    source_paths = [ROOT / 'experiments/q4_planning.py', Path(__file__), ROOT / 'scripts/analyze_q4_absence_tail.py']
    ...
    if a.original_parity:
        original = json.loads((ROOT / 'runs/q34_deadline_test3000_20260913/q4_best_samples.json').read_text())
        matches = []
